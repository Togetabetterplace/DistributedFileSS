...
#include <iostream>
#include <string>
#include "ThreadPool.h" lib\imgui\examples\libs\glfw\include \GLFW
#include "lib/GLFW/glfw3.h" // Include GLFW library
#include "lib/imgui/imgui.h" // Include imgui library
#include "lib/imgui/backends/imgui_impl_glfw.h" // Include imgui_impl_glfw
#include "lib/imgui/backends/imgui_impl_opengl3.h" // Include imgui_impl_opengl3

/*
g++ -Ilib/imgui -Ilib/imgui/backends -Ilib/imgui/examples/libs/glfw/include -Ilib/imgui/examples/libs/glad/include \
    src/main.cpp src/Peer.cpp src/DataSource.cpp src/ThreadPool.cpp \
    lib/imgui/imgui.cpp lib/imgui/imgui_demo.cpp lib/imgui/imgui_draw.cpp lib/imgui/imgui_tables.cpp lib/imgui/imgui_widgets.cpp \
    lib/imgui/backends/imgui_impl_glfw.cpp lib/imgui/backends/imgui_impl_opengl3.cpp \
    -Llib/imgui/examples/libs/glfw -lglfw -Llib/imgui/examples/libs/glad -lglad -lGL -ldl -lpthread -o DistributedProject
*/
static void
