...
/*
g++ - Ilib / imgui - Ilib / imgui / backends - Ilib 
/ imgui / examples / libs / glfw / include - Ilib 
/ imgui / examples / libs / glad / include src
 / main.cpp src / Peer.cpp src / DataSource.cpp src 
 / ThreadPool.cpp lib / imgui / imgui.cpp lib / imgui
  / imgui_demo.cpp lib / imgui / imgui_draw.cpp lib / imgui / imgui_tables.cpp lib / imgui / imgui_widgets.cpp lib / imgui / backends / imgui_impl_glfw.cpp lib / imgui / backends / imgui_impl_opengl3.cpp - Llib / imgui / examples / libs / glfw - lglfw - Llib / imgui / examples / libs / glad - lglad - lGL - ldl - lpthread - o DistributedProject
