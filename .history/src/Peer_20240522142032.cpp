 ...
 *
 * This function is responsible for receiving and processing requests from the client.
 * After processing the request, the function closes the client socket.
 *
...
//显示当前节点信息
void Peer::displayNodeInfo() const
{
