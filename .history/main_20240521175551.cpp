...
void displayMenu()
{
    ...
    std::cout << "-----------------------------------------------------------" << std::endl;
    std::cout << "1. Add a known peer:-d add" << std::endl;
    std::cout << "2. Remove a known peer" << std::endl;
    std::cout << "3. Add a data source" << std::endl;
    std::cout << "4. Remove a data source" << std::endl;
    std::cout << "5. Set synchronization period" << std::endl;
